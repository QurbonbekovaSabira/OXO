  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#paint0_radial_307_7762)"
      />
      <defs>
        <radialGradient
          id="paint0_radial_307_7762"
          cx={0}
          cy={0}
          r={1}
          gradientUnits="userSpaceOnUse"
          gradientTransform="translate(4.72727 3.71834) rotate(67.3828) scale(18.9112 23.0346)"
        >
          <stop stopColor="#FF4040" />
          <stop offset={1} stopColor="#FA7800" />
        </radialGradient>
      </defs>
    </svg>
  );
